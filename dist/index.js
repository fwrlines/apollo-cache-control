    ...
    willSendResponse(o) {
        if (this.options.calculateHttpHeaders && o.graphqlResponse.http) {
            ...
            if (overallCachePolicy) {
                o.graphqlResponse.http.headers.set('Cache-Control', `s-maxage=${overallCachePolicy.maxAge}, max-age=${overallCachePolicy.maxAge}, ${overallCachePolicy.scope.toLowerCase()}`);
            }
        }
    }
